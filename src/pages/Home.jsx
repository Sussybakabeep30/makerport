...
const Home = () => {
  ...
  return (
    <div className="animate-fade-in">
            ...
            <div className="md:flex md:items-center md:justify-between">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    href="/portfolio"
                    className="inline-flex items-center px-6 py-3 bg-white text-primary-800 hover:bg-orange-500 font-semibold rounded-md hover:bg-primary-50 transition-colors"
                  >
                    View my work
                ...
                {isLoggedIn ? (
                  <div className="text-center">
                    <div className="inline-block p-3 bg-primary-100 rounded-full mb-4">
                      <div className="h-10 w-10 text-primary-600 text-3xl">
                        🖨️
                      </div>
                    </div>
                    <h2 className="text-indigo-400 text-2xl font-bold mb-2">
                      Welcome back!
                    </h2>
      ...
      <div className="max-w-7xl mx-auto px-4 bg-white sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 hover:shadow-xl">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Gadgets</h3>
              <p className="text-gray-600 mb-4">
